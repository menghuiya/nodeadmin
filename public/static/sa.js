...
(function () {
  ...
  sa.checkAuth = function (pcode, not_pcode_url) {
    ...
    if (is_have == false) {
      location.href = not_pcode_url || '/admin/sa-html/error-page/403';
      throw '暂无权限: ' + pcode;
    }
  };
  ...
  sa.checkAuthTs = function (pcode, not_pcode_url) {
    var is_have = sa.keyListHas(pcode_key, pcode);
    if (is_have == false) {
      var url = not_pcode_url || '/admin/sa-html/error-page/403';
      layer.open({
        type: 2,
        title: false, // 标题
