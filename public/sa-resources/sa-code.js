...
// 设置模板标题
sa_admin.title = '梦回后台管理';
sa_admin.logo_url = '/public/sa-resources/admin-logo.png'; // 设置logo图标地址   默认值：sa-resources/admin-logo.png
sa_admin.icon_url = '/public/sa-resources/admin-logo.png'; // 设置icon图标地址   默认值：sa-resources/admin-logo.png
...
sa_admin.user = {
  username: 'root', // 昵称
  avatar: '/public/sa-resources/admin-logo.png' // 头像地址
};
